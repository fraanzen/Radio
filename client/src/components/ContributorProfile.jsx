      ...
      <div className="container">
        ...
        <div className="text-center mb-5">
          ...
          <p className="text-white-50">
            Manage your information and track your work
          </p>
        </div>
                    ...
                    {profile.paymentHistory.map((payment) => (
                      <tr key={payment.id}>
                        ...
                        <td className="text-muted">
                          {formatCurrency(payment.subtotalAmount)}
                        </td>
                        <td className="text-muted">
                  ...
                  <tbody>
                    {profile.recentAssignments.map((assignment) => (
                      <tr key={assignment.id}>
                        ...
                        <td className="text-muted">
                          {formatDateTime(assignment.contentStartTime)}
                        </td>
                        <td>
                          <span className="badge bg-light text-dark">
                            {Math.floor(
          ...
          <div className="card-body p-4">
            <div className="d-flex align-items-center mb-4">
              ...
              <div>
                ...
                <p className="text-muted mb-0 small">
                  Your earnings per hour and event
                </p>
              </div>
            </div>
            ...
            <div className="row g-4 mb-4">
              <div className="col-md-4">
                ...
                >
                  ...
                  <h6 className="text-white text-opacity-75 mb-2 small">
                    HOURLY RATE
                  </h6>
                  ...
                  <div className="d-flex align-items-start">
                    ...
                    <div>
                      ...
                      <div className="fw-semibold">
                        (750 × 1h + 300) × 1.25 ={" "}
                        <span style={{ color: "#10b981" }}>1,312.50 SEK</span>
                      </div>
                    </div>
                  </div>
                </div>
                <div className="col-md-6">
                  <div className="d-flex align-items-start">
                    ...
                    <div>
                      ...
                      <div className="fw-semibold">
                        (750 × 2h + 300) × 1.25 ={" "}
                        <span style={{ color: "#10b981" }}>2,250 SEK</span>
                      </div>
                    </div>
                  </div>
                </div>
